...
# REMOVED: Duplicate import from entities.core
# 이전에는 entities.core에서 Weapon, Player, Enemy, Boss, Bullet을 import했으나
# objects.py에서 동일한 클래스를 재정의하여 덮어쓰고 있었습니다.
# 혼란 방지를 위해 import문을 제거하고 objects.py의 정의만 사용합니다.
